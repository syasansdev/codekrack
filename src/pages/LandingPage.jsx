              ...
              >
                ...
                <div className="flex-1 overflow-y-auto bg-gray-50 p-2 sm:p-4 flex justify-center">
                  <div className="w-full max-w-3xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex justify-center h-full">
                    <iframe
                      src="https://docs.google.com/forms/d/e/1FAIpQLScm5RQR1VrQVrujvX59tK4Y8-mYjxaiWachfVvdtArbj1S7Bg/viewform?embedded=true"
                      width="100%"
                      height="800"
              ...
              >
                <div className="relative overflow-hidden rounded-3xl border border-blue-100 shadow-xl bg-white p-6 sm:p-10 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
                  ...
                  <div className="shrink-0 flex flex-col items-center gap-2.5">
                    ...
                    <a 
                      href="https://docs.google.com/forms/d/e/1FAIpQLScm5RQR1VrQVrujvX59tK4Y8-mYjxaiWachfVvdtArbj1S7Bg/viewform"
                      target="_blank"
                      rel="noopener noreferrer"
