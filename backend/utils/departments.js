...
// department name.
//
// KEEP IN SYNC WITH src/lib/departments.js. This copy is the one that DECIDES:
// the browser list is for picking, but a registration can be posted with curl,
// so the server checks membership itself.
